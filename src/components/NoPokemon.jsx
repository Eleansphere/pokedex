...
export default function NoPokemon(){
    ...
    return(
        <section className='flex items-end justify-center flex-col  bg-green-900 p-3 rounded-xl w-full md:w-1/3 h-60 sm:w-1/3 bg-[url(./assets/pokeball_bg.png)] bg-contain bg-no-repeat bg-left'>
